...
const FWGlobals = (() => {
  const MODULE_NAMES = [
    ...
    'FWRng', 'FWSimClock', 'FWReconcile', 'FWCopyRules', 'FWRenderGuards', 'FWLiveSimStore', 'FWEntityTruck', 'FWEntityDriver',
    ...
    'FWFalsePositiveEngine', 'FWIntentEngine', 'FWEvolutionEngine', 'FWBehaviorEngine', 'FWSignalEngine', 'FWMoEngine', 'FWActEngine',
    'FWInvestigationEngine', 'FWCandidateEngine', 'FWAdviceEngine', 'FWOutcomeEngine', 'FWExposureModel',
    'FWAnalyticsEngine', 'FWSimRunner', 'FWSimDebug', 'FWMoIntelligence', 'FWDiscoveryLab',
  ...
  const BINDINGS = {
    ...
    FWEvolutionEngine: () => FWEvolutionEngine,
    ...
    FWCandidateEngine: () => FWCandidateEngine,
    ...
    FWDiscoveryLab: () => FWDiscoveryLab,
    FWEntityInspector: () => FWEntityInspector,
    FWCaseExport: () => FWCaseExport,
